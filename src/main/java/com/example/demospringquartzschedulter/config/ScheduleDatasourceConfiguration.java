...
@Configuration
@EnableJpaRepositories(basePackages = "com.example.demospringquartzschedulter.repository",
...
public class ScheduleDatasourceConfiguration {
  ...
  public LocalContainerEntityManagerFactoryBean scheduleEntityManager(
    ...
    return builder
        ...
        .packages("com.example.demospringquartzschedulter.entity")
        .build();
  }
  ...
  public PlatformTransactionManager scheduleTransactionManager(
      final @Qualifier("scheduleEntityManager") LocalContainerEntityManagerFactoryBean scheduleEntityManager) {
    return new JpaTransactionManager(Objects.requireNonNull(scheduleEntityManager.getObject()));
  }
}
